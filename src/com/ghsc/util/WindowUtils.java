...
import com.ghsc.util.WindowUtils.SnapAdapter.Side.Align;
import com.ghsc.util.WindowUtils.SnapAdapter.Side.Type;
...
public class WindowUtils {
	...
	public static void center(Component comp, Component target) {
		...
		comp.setLocation(new Point((bounds.x + (bounds.width / 2)) - (comp.getWidth() / 2), 
								   (bounds.y + (bounds.height / 2)) - (comp.getHeight() / 2)));
	}
	...
	public static class SnapAdapter extends ComponentAdapter {
